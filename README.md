...
- Windows x64/x86/ARM build of Notepad++. **Pick the correct version, or use the [all-in-one package here](https://github.com/pullitall/Notepadpp-light-dark-switch-and-automatic-switch-based-on-location/releases/download/1.0.2/DARK_MODE_NPP_v1.0.2-unified.zip).**
